...
```javascript
const pleiterson = {
  code: ['C++', 'C#', 'HTML', 'CSS', 'JavaScript', 'TypeScript', 'Java', 'Python', 'GraphQL'],
  certifications: ['SFC', 'SFPC', 'LLL'],
  technologies: {
    tools: ['Node.js', 'React', 'Yarn', 'npm', 'git', 'styled-components', 'SASS', 'Vite', 'Next.js', 'Mest.js'],
    mobile: ['React Native'],
    databases: ['SQL Server', 'PostgreSQL', 'MongoDB', 'MySQL', 'SQLite', 'Docker'],
    ides: ['VS Code', 'Visual Studio'],
  },
  methodologies: ['Scrum', 'Kanban', 'Agile', 'Jira', 'DevOps'],
  interest: ['php', 'Ruby', 'Kotlin', 'Angular', 'Bootstrap'],
